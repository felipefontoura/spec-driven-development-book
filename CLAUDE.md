...
├── CLAUDE.md           # This file
├── sdd-kit/            # Ready-to-use SDD commands/templates for readers
...
- Use emojis in labels for context: 📋 📦 🔔 ⚡ 🗄️
- Use consistent colors with `style`:
  - Blue (#3b82f6): inputs, requirements
  - Purple (#8b5cf6): processing, design
  - Yellow (#f59e0b): queues, warnings
  - Green (#10b981): outputs, success
- Group related elements with `subgraph`
- Use `---` for optional connections, `-->` for required ones
